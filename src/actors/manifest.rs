...
impl ActorManifest {
    pub fn mind_phase_one() -> Self {
        ...
        let actors = vec![
            ...
            ManifestEntry::new(TraceNode::CHOREOGRAPHY_ADJUDICATOR, long_lived),
            ManifestEntry::new(TraceNode::MIND_ORCHESTRATE_CALLER, long_lived),
            ...
            ManifestEntry::new(TraceNode::KNOWLEDGE_ADMISSION, long_lived),
            ManifestEntry::new(TraceNode::KNOWLEDGE_JUDGE_CALLER, long_lived),
        ...
        let edges = vec![
            ...
            ManifestEdge::new(TraceNode::MIND_ROOT, TraceNode::CHOREOGRAPHY_ADJUDICATOR),
            ...
            ManifestEdge::new(TraceNode::STORE_SUPERVISOR, TraceNode::KNOWLEDGE_ADMISSION),
            ManifestEdge::new(
            ...
            ManifestEdge::new(TraceNode::KNOWLEDGE_ADMISSION, TraceNode::STORE_KERNEL),
            ManifestEdge::new(
